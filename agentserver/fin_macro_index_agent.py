...
class MacroeconomicAnalysisAgent(Node):
    ...
    거시경제 지표는 기업의 실적과 투자자 심리에 직접적인 영향을 미치는 핵심 요소입니다. 
    예를 들어, 환율 변동은 수출 기업의 실적과 외국인 투자자금 흐름에 영향을 주며, 
    금리는 기업의 자금 조달 비용과 투자자들의 자산 배분 결정에 중요한 역할을 합니다. 
    또한 원자재 가격의 변동은 제조업체의 수익성과 물가에 직접적인 영향을 미칩니다. 

    따라서 거시경제 에이전트는 환율, 금리, 원자재 가격 등의 실시간 데이터를 수집하여서
    거시경제 변수들이 주식 시장에 미치는 복합적인 영향을 LLM이 분석하고 투자자들의 의사결정에 필요한 통찰력을 제공합니다.
